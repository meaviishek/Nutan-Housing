    ...
    <div>
        <Scrolltop/>
            ...
            <div className="max-w-7xl  mx-auto py-6 md:py-12    ">
                ...
                <p className='text-md text-gray-900 leading-7 mb-6 mx-4 text-justify font-poppins'>At Nutan Housing Finance, we take pride in redefining modern living through our innovative Housing projects that prioritize both quality and sustainability. Each of our Projects is meticulously designed to harmonize with the surrounding environment while providing residents with the ultimate in comfort and functionality. We understand that a home is more than just a place to live; it’s a sanctuary where life unfolds. That’s why our projects incorporate spacious layouts, modern amenities, and thoughtful details that cater to the diverse needs of families and individuals alike.
<br/>
